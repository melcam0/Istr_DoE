...
La versione eseguibile del programma PCA.exe è in versione beta. Vi preghiamo quindi di provarlo e di segnalare eventuali bug o errori (ad esempio, mancanza di libreria, ecc...) ai seguenti indirizzi: [Giorgio Marrubini](mailto:giorgio.marrubini@unipv.it), [Camillo Melzi](mailto:camillomelzi@gmail.com).

Purtroppo, l'eseguibile attualmente funziona solo per Windows.

## 2. Scaricare l'eseguibile

Scaricare il file <a href="https://drive.google.com/open?id=1IEVIbt_LWVE6Ry-XRDBGt_r6FbVQbAZJ&authuser=camillomelzi%40gmail.com&usp=drive_fs" target="_blank">setup\_PCA.exe</a> ed avviare l'eseguibile con doppio click sull'icona
