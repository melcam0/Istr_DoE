...
4.  Per installare i pacchetti necessari al funzionamento dell'applicativo **DoE** aprire la cartelletta dezippata **DoE**, aprire il file **Pacchetti.R** con **RStudio** (doppio click sul file). Quindi cliccare sul tasto *Source* (ci vorrà qualche minuto).![](Figure/RStidio1.png){width="683"}
