...
Download the file [setup_DoE.exe](https://drive.google.com/file/d/1cGdES0TLqMHN4E4cGvr_TvCaM-1VVLLo/view?usp=sharing) then run the executable by mouse double-click  on the icon: 
